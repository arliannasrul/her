...
function createBallpit(e, t = {}) {
  try {
    ...
    console.warn('Ballpit initialization failed:', err);
    return null;
  }
}
...
const Ballpit = ({ className = '', followCursor = true, ...props }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('Ballpit failed to load:', err);
    }
  ...
  useEffect(() => {
    ...
    if (spheresInstanceRef.current && spheresInstanceRef.current.updateConfig) {
      spheresInstanceRef.current.updateConfig({ followCursor, ...props });
    }
  }, [props, followCursor]);

  return <div className={`${className} w-full h-full relative`} ref={containerRef} />;
};
